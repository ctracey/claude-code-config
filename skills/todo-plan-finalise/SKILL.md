---
name: todo-plan-finalise
description: Finalise the planning docs — fill any remaining gaps, run todo-report, and confirm ready to start. Final phase of the planning conversation. Use at the end of a planning session or when invoked via /todo-plan-finalise.
