---
name: plan-intent
description: Understand the intent behind a piece of work — why it exists, for whom, and what success looks like. Second phase of the planning conversation. Use when exploring motivation and goals, or when invoked via /plan-intent.
