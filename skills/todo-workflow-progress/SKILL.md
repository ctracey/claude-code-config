---
name: todo-workflow-progress
description: Print a workflow progress banner showing title, all stages, and the active stage highlighted. Use when starting a new stage in a multi-stage workflow, or when invoked via /todo-workflow-progress.
allowed-tools: Bash
---
...
```
/todo-workflow-progress title="process X" stages="stage 1,stage 2,stage 3" active="stage 2"
```
...
```
echo '{"title": "...", "stages": "...", "active": "..."}' | python3 ~/.claude/skills/todo-workflow-progress/progress.py
```
