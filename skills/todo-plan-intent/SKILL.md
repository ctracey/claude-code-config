---
name: todo-plan-intent
description: Understand the intent behind a piece of work — why it exists, for whom, and what success looks like. Second phase of the planning conversation. Use when exploring motivation and goals, or when invoked via /todo-plan-intent.
...
Calibrate depth to the complexity of the work. For small tasks, one or two exchanges is enough. Draw from these selectively — not as a checklist:
