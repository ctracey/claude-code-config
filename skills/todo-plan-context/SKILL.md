---
name: todo-plan-context
description: Resolve the PR number, check for existing todo files, determine how new work relates to existing work, and create stub planning docs. First phase of the planning conversation. Use at the start of a planning session or when invoked via /todo-plan-context.
...
- Skip to `todo-plan-delivery` (no new plan doc needed unless the user wants one).
