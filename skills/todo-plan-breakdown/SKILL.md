---
name: todo-plan-breakdown
description: Propose and confirm the task breakdown for a piece of work. Fifth phase of the planning conversation. Use when creating a task list, or when invoked via /todo-plan-breakdown.
...
Wait for any final adjustments, then proceed to `todo-plan-finalise`.
